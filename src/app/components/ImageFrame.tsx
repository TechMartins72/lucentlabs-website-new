        ...
        >
          <div className="h-full bg-linear-to-br from-[#2897DB] to-[#F60077] relative shrink-0">
            ...
            <div
              ...
              } w-full absolute z-10 bottom-1 left-0 flex flex-col justify-center items-center p-6`}
            >
              <div>
            ...
            <Image
              ...
              height={444}
              width={200}
              className={`absolute top-0 md:left-[23%] left-[25%] z-100 ${
